# Generated by Django 4.1.6 on 2023-03-12 13:56
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(default=datetime.datetime(2023, 3, 12, 13, 56, 48, 836165, tzinfo=datetime.timezone.utc), help_text='The date and time when the blog post was created.')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sub_content', models.ManyToManyField(help_text='The sub content for the step-by-step guide.', related_name='step_by_step_guides', to='blog.subcontent')),
                ('sub_heading', models.ManyToManyField(help_text='The subheadings for the step-by-step guide.', related_name='step_by_step_guides', to='blog.subheading')),
            ],
            options={
