    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(default=datetime.datetime(2023, 3, 12, 14, 3, 25, 116144, tzinfo=datetime.timezone.utc), help_text='The date and time when the blog post was created.')),
