...
(function () {
        ...
        init: function (editor) {
            ...
            editor.on(
                ...
                function (evt) {
                    ...
                    embedCandidatePasted =
                        match != null &&
                        decodeURI(match[1]) == decodeURI(match[2]);
    ...
    function autoEmbedLink(editor, id) {
        ...
        var href = anchor.data("cke-saved-href"),
            widgetDef = CKEDITOR.plugins.autoEmbed.getWidgetDefinition(
                editor,
                href
            );
        ...
        instance.loadContent(href, {
            ...
            callback: function () {
                ...
                if (anchor) {
                    ...
                    if (
                        editable.contains(startNode) &&
                        editable.contains(endNode)
                    ) {
