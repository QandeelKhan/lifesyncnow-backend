    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('paragraphs_privacy_policy', models.ManyToManyField(blank=True, related_name='privacy_policy', to='ContactUs.paragraph')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('list_style', models.CharField(blank=True, choices=[('simple', 'Simple'), ('bulleted', 'Bulleted'), ('bulleted', 'Bulleted'), ('numbered', 'Numbered'), ('asterisk', 'Asterisk'), ('dotted', 'Dotted')], default='simple', help_text='The list style of the paragraph.', max_length=50, null=True)),
                ...
                ('contact_us', models.ForeignKey(help_text='The post that this step-by-step guide belongs to.', on_delete=django.db.models.deletion.CASCADE, related_name='step_by_step_guides_contact_specific', to='ContactUs.contactus')),
                ('privacy_policy', models.ForeignKey(blank=True, help_text='The post that this step-by-step guide belongs to.', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='privacy_policy', to='ContactUs.privacypolicy')),
        ...
        migrations.AddField(
            ...
            name='paragraphs',
            field=models.ManyToManyField(blank=True, related_name='paragraphs_contact_us', to='ContactUs.paragraph'),
        ),
        migrations.AddField(
